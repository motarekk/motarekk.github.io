...
function ascon_128a_KAT(){
    var variant = 'Ascon-128a';
    ...
    for(var i = 0; i < ascon_128a_kats.length; i++){
        var pt = to_unicode(ascon_128a_kats[i].PT);
        var ad = to_unicode(ascon_128a_kats[i].AD);
        var ct = ascon_128a_kats[i].CT;
